...
namespace CommerceProjectTests
{
    [TestClass]
    public class CartTotalShouldReturn
    {
        ...
        [TestMethod]
        public void FourDollarsWithFourBuy4Get1FreeItems_Solid()
        {
            var item = new OrderItem() { Quantity = 4, Sku = "B4GO_APPLE" };
            var sut = new Buy4GetOneFree();
            var result = sut.CalculatePrice(item);
